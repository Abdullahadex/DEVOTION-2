...
const LetterTyping: React.FC<LetterTypingProps> = ({ onComplete }) => {
  const actions = useMemo(() => [
    ...
    // The apology
    { type: 'type' as const, text: "Jennifer, I know I messed up. I know I haven't been the best person to you, and I'm truly sorry for that.", speed: 50 },
    { type: 'newline' as const },
    { type: 'newline' as const },
    { type: 'pause' as const, duration: 800 },

    // Context - what's been going on
    { type: 'type' as const, text: "I've been going through a lot of phases lately, and I've been sick. That's not an excuse, but I want you to know that I would never snub you again. Never.", speed: 48 },
    { type: 'newline' as const },
    { type: 'newline' as const },
    { type: 'pause' as const, duration: 1000 },
    ...
    // The sign-off
    { type: 'type' as const, text: "I love you so much Jennifer.", speed: 60 },
    { type: 'newline' as const },
    { type: 'pause' as const, duration: 800 },
